        ...
        return (
            <React.Fragment>
                <Container>
                    ...
                    <Form onSubmit={(e) => this.signUp(e)} style={{ width: "50%", marginLeft: 'auto', marginRight: 'auto' }}>
                        <FormGroup>
                            <Label for="displayName">Name</Label>
                            <Input type="displayName" name="displayName" value={this.state.displayName} onChange={(event) => this.updateValue("displayName", event.target.value)} id="display-name" placeholder="Your Name" />
                        </FormGroup>
                        <FormGroup>
                        ...
                        <div style={{ textAlign: 'center' }}>
                            <Button type="submit" onClick={(event) => this.signUp(event)} color="primary">Sign Up</Button>
                        </div>
                    </Form>
                </Container>
            </React.Fragment>
